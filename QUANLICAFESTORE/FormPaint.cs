...
{
    public partial class DemoPaint : Form
    {
        ...
        private void DemoPaint_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void DemoPaint_Load(object sender, EventArgs e)
        {
        ...
        private void DemoPaint_MouseDown(object sender, MouseEventArgs e)
        {
            _x1 = e.X;
            _y1 = e.Y;
        ...
        private void DemoPaint_MouseMove(object sender, MouseEventArgs e)
        {
            _x2 = e.X;
            _y2 = e.Y;
            _dx = e.X - _x1;
        ...
        private void DemoPaint_MouseUp(object sender, MouseEventArgs e)
        {
            _isNeedSave = true;
            _dx = _x2 - _x1;
            _dy = _y2 - _y1;
        ...
        private void DemoPaint_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void DemoPaint_Resize(object sender, EventArgs e)
        {
            RefreshFormBackground();
        }
